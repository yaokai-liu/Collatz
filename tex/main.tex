...
\newcommand{\CollatzReduce}[2]{\val_{\beta}({#1};{#2})}
...
\begin{abstract}
    ...
    Some propositions that are indispensable to proving the $3n + 1$ conjecture are then provided and provide a dynamic system view on difference of powers problem.
...
\input{SECTION-introduction-and-the-general-collatz-sequence}
\input{SECTION-the-basic-formula-of-collatz-sequences}
\input{SECTION-extend-the-field-of-values-for-the-collatz-sequence}
\input{SECTION-back-trace-the-collatz-sequence}
\input{SECTION-varies-in-source-value-with-respect-to-the-reduce-sequence}
\input{SECTION-distribution-of-multi-step-collatz-primitive-source}
\input{SECTION-homomorphisms-preserves-measure-between-source-value-set}
