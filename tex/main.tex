...
Denote $\mathbb{A}_n(b) = \{ \bm{s} \in \mathbb{Z}^{n} \mid \Gamma_n \in \mathbb{N}\}$ and $\mathbb{F}_n(b) = \{ f_n(\bm{a} + \bm{s}) \mid \bm{s} \in \mathbb{A}_n(b) \}$. Specially, we define $\mathbb{A}_0(b) = \varnothing$ and $\mathbb{F}_0(b) = \{b\}$. Then there is
\begin{conjecture}
...
Let's consider the $0$-step primitive source. 
\begin{proposition}
