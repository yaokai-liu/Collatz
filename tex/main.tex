...
\begin{proof}
    ...
    \end{aligned}\]
    Thus, this proposition has been proved.
\end{proof}

And immediately, we have
\begin{proposition}~\label{prop:integral-trans}
...
Back to the \cref{prop:vary-rule}.
...
\begin{theorem}
    Suppose $f_{n}(\bm{a}) = \sum_{k=0}^{\infty}x_k\beta^{k}$ and $f_{n}(\bm{a} + \bm{s}) = \sum_{k=0}^{\infty}x'_k\beta^{k}$. If there's 
    \[ \gamma \cdot \sum_{k=0}^{n-1}\beta^{\mathcal{A}_{k} + \mathcal{S}_{k}}\cdot\alpha^{n-k-1}\cdot(\beta^{\mathcal{S}_{n}^{k}} - 1) \equiv 0 \pmod{\alpha^{n}}, \]
    then $\exists m \ge 0$, such that
    \[ \sum_{k=0}^{\infty}x'_{k + m}\beta^{k} = \sum_{k=0}^{\infty}x_{k + m - \mathcal{S}_k}\beta^{k} + \delta, \]
    where the $\delta\in\{0, 1\}$.
\end{theorem}
Notice that we don't limit the $f_{n}(\bm{a})$ and $f_{n}(\bm{a} + \bm{s})$ in $\mathbb{N}$, that means they can be any $\beta$-adic number.
\begin{proof}
    Let
    \[ \Gamma = \frac{\gamma}{\alpha^{n}}\cdot\sum_{k=0}^{n-1}\beta^{\mathcal{A}_{k} + \mathcal{S}_{k}}\cdot\alpha^{n-k-1}\cdot(\beta^{\mathcal{S}_{n}^{k}} - 1). \]
    Since the congruence equation holds, then $\Gamma \in \mathbb{N}$, that means $\deg_{\beta}(\Gamma)<\infty$. Let $m = \max\{\deg_{\beta}(\Gamma), \mathcal{S}_n\} + 1$, then
    \[ \beta^{m - 1}\le\beta^{\mathcal{S}_k}\sum_{k=0}^{m - \mathcal{S}_k - 1}x_k\beta^{k} + \Gamma \le \beta^{m}. \]
    And from \cref{prop:vary-rule}, we have
    \[ \sum_{k=0}^{\infty}x'_k\beta^{k} = \beta^{\mathcal{S}_k}\sum_{k=0}^{m - \mathcal{S}_k - 1}x_k\beta^{k} + \Gamma + \beta^{\mathcal{S}_k}\sum_{k=m}^{\infty}x_{k}\beta^{k}. \]
    Let's right shift both the series by $m$, then we have
    \[ \sum_{k=m}^{\infty}x'_k\beta^{k - m} = \sum_{k=m - \mathcal{S}_k}^{\infty}x_{k}\beta^{k-m + \mathcal{S}_{n}} + \delta. \]
    Adjusting the subscript yields
    \[ \sum_{k=0}^{\infty}x'_{k + m}\beta^{k} = \sum_{k=0}^{\infty}x_{k + m - \mathcal{S}_k}\beta^{k} + \delta. \]
\end{proof}

\begin{conjecture}
    Suppose $x = \sum_{k=0}^{\infty}x_k\beta^{k}$ and $x' = \sum_{k=0}^{\infty}x'_k\beta^{k}$. If $\exists m \ge 0$ and $\bm{s}\in \mathbb{N}^{n}$, such that
    \[ \sum_{k=0}^{\infty}x'_{k + m}\beta^{k} = \sum_{k=0}^{\infty}x_{k + m - \mathcal{S}_k}\beta^{k} + \delta, \]
    and holds
    \[ \gamma \cdot \sum_{k=0}^{n-1}\beta^{\mathcal{A}_{k} + \mathcal{S}_{k}}\cdot\alpha^{n-k-1}\cdot(\beta^{\mathcal{S}_{n}^{k}} - 1) \equiv 0 \pmod{\alpha^{n}}, \]
    let $x \overset{n}{\rightsquigarrow} b$, then $x' \overset{n}{\rightsquigarrow} b$.
\end{conjecture}


Since the congruence of \cref{prop:integral-trans} equation can be convert a series of prime number's congruence.
...
we can first consider $\alpha\in \mathbb{P}$.
...
\begin{definition}[Collatz primitive source]~\label{collatz-primitive-source}
    For $b\in \mathbb{N}-\beta\mathbb{N}$, if there is a sequence $\bm{a}\in \mathbb{N}^{n}$ such that $f_{n}(a)$ is not reversible modulo $\alpha$, or
    \[\Log_{\beta, \alpha}(f_{n}(a)^{-1} \cdot \gamma) = \varnothing, \]
