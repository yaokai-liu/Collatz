...
\end{proof}
From now we denote
\[ \Gamma_n = \frac{\gamma}{\alpha^{n}}\cdot\sum_{k=0}^{n-1}\beta^{\mathcal{A}_{k} + \mathcal{S}_{k}}\cdot\alpha^{n-k-1}\cdot(\beta^{\mathcal{S}_{n}^{k}} - 1). \]
Then this proposition can be written as $f_{n}(\bm{a} + \bm{s}) = \beta^{\mathcal{S}_{n}}\cdot f_{n}(\bm{a}) + \Gamma_n$. Additionally, if $n$ is explicit, we abbreviate $\Gamma_n$ to $\Gamma$.
Actually we have
\begin{corollary}
...
Denote that
\[ \begin{aligned}
    \mathbb{A}_n(b) &= \left\{ \bm{s} \in \mathbb{Z}^{n} \mid b\cdot\beta^{\mathcal{S}_n} + \Gamma_n \in \mathbb{N} \right\},\\
    \mathbb{F}_n(b) &= \left\{ f_n(\bm{a} + \bm{s}) \mid \bm{s} \in \mathbb{A}_n(b) \right\}.
\end{aligned} \]
Specially, we define $\mathbb{A}_0(b) = \varnothing$ and $\mathbb{F}_0(b) = \{b\}$.
\end{definition}
\begin{conjecture}
...
\[ \begin{aligned}
    ...
    \mathbb{F}_{n+1}(b) &= \left\{ \left.\frac{\beta^{\Delta}\cdot f  - 1}{3} \right\vert 2^{\Delta}\cdot f \equiv 1\pmod{2}, f \in \mathbb{F}_{n}(b) \right\}.
\end{aligned} \]
\end{proposition}
...
\begin{definition}[Collatz primitive source]~\label{collatz-primitive-source}
    ...
    \[\mathbb{S} = \{b \in \mathbb{N}-\beta\mathbb{N} \mid \gcd(b, \alpha) = 1 \text{ and } \Log(b^{-1}\cdot\gamma) = \varnothing\}, \]
    and all non-trivial primitive source vector of $b$ denoted as
    \[ \mathbb{V}_{b}^{n} = \{\bm{a} \in \mathbb{N}^{n} \mid  f_{n}(\bm{a}) \in \mathbb{S}\}. \]
\end{definition}
...
Immediately, we have
\begin{proposition}
    If $(\alpha, \beta, \gamma) = (3,2,1)$, then $\mathbb{S} = \varnothing$.
\end{proposition}
\begin{proposition}
