...
In fact, \cref{thm:the-periodic-rule-of-reduce-sequence} presents the variaty of $s$ that preserve integers, which do not depend on the original reduced sequence $\bm{v}$, but only on the position $k$.
...
% \end{corollary}
% This corollary present that, the effect of adjust vector just equivalents to the result of adjust every component in steps.
