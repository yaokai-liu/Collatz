...
\begin{definition}~\label{def:collatz-character}\nomenclature{$\chr b$}{Collatz character of $b$, \cref{def:collatz-character}}
    Given $b \in\widehat{\mathbb{N}}_\beta$, define $\chr b = \min_{v\in\mathbb{N}_{\ge1}}\{\beta^{v}b: \alpha\mid(\beta^{v}b-\gamma)\}$ called the Collatz cahracter of $b$. If $\{\beta^{v}b: \alpha\mid(\beta^{v}b-\gamma)\} = \varnothing$, we define $\chr b = \infty$.
\end{definition}
\begin{proposition}
...
\begin{proposition}
    $\chr(a + m\alpha) = \chr a + m\alpha\cdot\pow(\beta\mid\chr a)$.
\end{proposition}
