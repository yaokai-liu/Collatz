...
\begin{corollary}~\label{cor:form-of-1-step-source-value-set}
    Denote $\mathbb{B} = \{\beta^{k\Phi}\mid k\in\mathbb{N}\}$. $\forall b\in\widehat{\mathbb{N}}_\beta - \mathbb{S}$, we have
    \[ \mathbb{F}_{1}(b) = \frac{\chr b}{\alpha}\mathbb{B} - \frac{\gamma}{\alpha}. \]
\end{corollary}
