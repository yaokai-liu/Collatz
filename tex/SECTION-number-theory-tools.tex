...
\begin{proposition}
    ...
    \[ \log_{a, b}(x \cdot y) = (\log_{a, b}x + \log_{a, b}y) \mod{\ord_{a}b}. \]
\end{proposition}
\begin{proposition}
    Suppose $\log_{a, b}x < \infty$.
    Given $n \in \mathbb{N}$, we have
    \[ \log_{a, b}(x ^{n}) = n\log_{a, b}x \mod{\ord_{a}b}. \]
\end{proposition}
\begin{proposition}
    Suppose $\log_{a,b}x < \infty$, then $\log_{a, b}(x^{-1}) = \ord_{a}b - \log_{a,b}x$.
\end{proposition}
...
\begin{theorem}~\label{thm:lte-radical-theorem}
    ...
    \end{aligned} \right.\]
\end{theorem}
Now let's introduce a kind of count function on infinite subsets of $\mathbb{N}$. Given $A \subset N$ that $\card{A} = \infty$ and $\forall a\in A$, $a > 1$.
\begin{definition}
...
\end{definition}
\begin{definition}
    Finally, for $s > 0$, we define $L(A;s) = \prod_{x\in A}(1-x^{-s})^{-1}$.
\end{definition}
\begin{proposition}
