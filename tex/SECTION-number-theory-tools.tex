...
\begin{definition}~\label{def:generated-subgroup}
    We define $G(a;b) = \{ a^{x} \mid 0 \le x < \ord_{b}(a) \}$ as the generated subgroup of $a$ modulo $b$.
\end{definition}
\begin{definition}
...
\end{proposition}
\begin{proposition}
    $G(a;b)/b \le (\mathbb{Z}/b)^{*}$ by multiplication.
\end{proposition}
\begin{proof}
    $1 = a^{0} \in G(a;b)$. $a^{-x} \equiv a^{\ord_{b} a - x} \pmod{b}$ and $a^{\ord_{b} a - x}\in G(a;b)$. $a^{x} \cdot a^{y} = a^{x + y} \equiv a^{(x + y) \fmod\ord_{b}a} \pmod{b}$ and $a^{(x + y) \fmod\ord_{b}a}\in G(a;b)$. Thus $G(a;b) \le (\mathbb{Z}/b)^{*}$.
\end{proof}
