...
\[- \Log_{a, b}x = \ord_a(b)\mathbb{Z} - \log_{a, b}x.\]
\end{definition}
We call $\log_{a, b}(x)$ the principal modulor logarithm of $x$, and $\Log_{a, b}(x)$ the modulor logarithms of $x$, and define $\log_{a, b}1 = 0$ and $\Log_{a, b}1 = \ord_{b}(a)\mathbb{Z}$.
