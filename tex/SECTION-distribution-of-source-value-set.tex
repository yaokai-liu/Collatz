...
% \begin{theorem}
% 	Given $a, b\in\widehat{\mathbb{N}}_{\beta} - \mathbb{S}$, we have $\lim_{N\to\infty}\frac{\card\{\mathbb{S}_{1}(a) \le N\}}{\card\{\mathbb{S}_{1}(b) \le N\}} = 1$.
% \end{theorem}
% \begin{proof}
% 	\begin{align*}
...
% \end{proof}
% \begin{corollary}
% 	$\forall a, b \in \widehat{\mathbb{N}}_\beta - \mathbb{S}$, we have $\lim_{N\to\infty}\frac{\card\{\mathbb{S}_{n}(a) \le N\}}{\card\{\mathbb{S}_{n}(b) \le N\}} > 0$.
% \end{corollary}
