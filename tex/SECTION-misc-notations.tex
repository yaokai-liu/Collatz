...
Sometimes we will construct a new structure from given structures by some operations. Here we define two kind of constructions.
\begin{definition}
...
We denote $G/H$ or $\frac{G}{H}$ as the quotient group of $G$ relative to $H$.
\end{definition}
