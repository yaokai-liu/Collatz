...
\begin{conjecture}[rewitten ABC conjecture]
	...
	Here $\mathcal{Q}^{\sharp} = \mathcal{Q} / \rad\mathcal{Q}$.
\end{conjecture}

\cref{thm:arithmetic-decomposition-to-dynamical-system} prompt us to investigate $\gamma_k$, the exact differential forms associated with such discrete dynamical systems. Naturally, these quantities are interrelated with the $r_k$, and thus they should be considered as well. However, we don't know yet what them represent in number theory.
