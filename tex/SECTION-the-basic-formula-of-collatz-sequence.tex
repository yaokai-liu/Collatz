...
\end{proposition}
\begin{proposition}
If $m \ge 1$, and $n \le \ord_{\beta(\alpha - 1)}$ then
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\equiv 0 && \pmod{\beta^{m}}
    \end{align*}
    Thus we have $\beta^{\min\{m, \mathcal{A}_1\}}\ \left\vert\ \gamma\cdot\sum_{i=0}^{n-2}\alpha^{i}\right.$.

    Since $\ord_{\beta(\alpha-1)}(\alpha) > n - 1$, we have $\beta\nmid\gamma\cdot\sum_{i=0}^{n-2}\alpha^{i} = \gamma\cdot\frac{\alpha^{n-1} - 1}{\alpha - 1}$. It means the $\min\{m, \mathcal{A}_1\}=0$. Since $m > 0$, thus $\mathcal{A}_1 = 0$. With this we have
    \[ \alpha^{n-1}a_1 + \gamma\cdot\sum_{i=0}^{n-2}\alpha^{i} \equiv 0 \pmod{\beta^{m}} \]
    with this, iterally, we can proof $\forall i < n$, there is $\mathcal{A}_i = 0$.
    Thus $\mathfrak{A}_n = \sum_{i = 0}^{n-1}\alpha^i$. Then we have
...
Now $\forall m, n \in\mathbb{N}$, $n\ge 1$, we denote
\[ \overline{[m\mid n]} = \left\{a \in \widehat{\mathbb{N}}_{\beta}\ \left|\  a\cdot\alpha^n + \gamma\cdot\sum_{i = 0}^{n-1}\alpha^i \equiv 0 \pmod{\beta^{m}}\right.\right\}. \]
We have
\begin{proposition}
    $[m\mid n] \subset \overline{[m\mid n]}$.
\end{proposition}
\begin{proposition}~\label{proposition:equivalence-of-classes}
    $a \in \overline{[m\mid n]} \Longleftrightarrow a\equiv -\frac{\gamma}{\alpha}\cdot\sum_{i=0}^{n-1}\alpha^{-i} \pmod{\beta^{m}}$.
\end{proposition}
\begin{theorem}~\label{thm:avaliable-in-finity-step}
    $\exists P \in \mathbb{N}_{\ge1}$, such that $\overline{[m\mid n + P]} = \overline{[m\mid n]}$.
\end{theorem}
\begin{proof}
    ...
    \end{align*}
    which means $a \in \overline{[m\mid n + P]} \Longleftrightarrow \overline{[m\mid n]}$.
\end{proof}
\begin{remark}
...
\begin{proposition}
    ...
    On the contrary, if $a\equiv \gamma \pmod{\alpha}$, then $a \in \overline{[1]} \Longrightarrow \frac{a - \gamma}{\alpha} \in \overline{[1]}$.
\end{proposition}
