...
\begin{proof}
    ...
    \[ \mathfrak{A}_k = \frac{\alpha^{t \cdot \ord_{\beta(\alpha - 1)}(\alpha)} - 1}{\alpha - 1} \equiv \frac{t\cdot\beta(\alpha - 1) + 1 - 1}{\alpha - 1} \equiv 0. \pmod{\beta} \]
...
\end{theorem}
\begin{proof}
    Let $P = \ord_{\beta^{m}}(\alpha) \cdot \prod_{p\in\Omega(\mathbb{P} \mid \beta)}\raf_{p}(\alpha-1)$.

    First, since $\gcd(\alpha, \beta) = 1$, for those $p \in \mathbb{P}$ that $p \mid \beta$, we have
    \begin{align*}
        \val_{p}(\alpha^P - 1) & \ge \val_{p}\left(\prod_{p\in\Omega(\mathbb{P} \mid \beta)}\raf_{p}(\alpha-1)\right) + \val_{p}(\alpha^{\ord_{\beta^{m}}(\alpha)} - 1) \\
