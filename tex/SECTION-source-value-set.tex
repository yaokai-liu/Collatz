...
\begin{proof}
    ...
    Now consider any layer $n > 1$. Since any $n$-step source value is just a $1$-step source value of a $n-1$-step source value. Thus they follow the conclusion of $n=1$. Thus we proved $\mathbb{S}_{n}(b)/\alpha\mathbb{Z} = \mathbb{Z}/\alpha\mathbb{Z}$.
\end{proof}
\begin{remark}
    Here $\mathbb{S}_{n}(b)/\alpha\mathbb{Z}$ only represents the remainders modulo  $\alpha$. Generally, $\mathbb{S}_{n}(b)$ will not be a group.
\end{remark}
...
Here we provide the result of \cref{thm:layers-of-reduce-space-and-source-value-set} in the classic Collatz problem.
...
\begin{definition}
    Define $F: \mathbb{S}_n(b)\to\mathbb{S}_{n+1}(b)$ that $F(a) = S(0; a)$ and define $\Phi: \mathbb{S}_1(b)\to \mathbb{S}_1(b)$ that $\Phi(S(m;b)) = S(m + 1;b)$.
\end{definition}
