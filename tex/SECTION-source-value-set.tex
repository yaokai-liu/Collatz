...
\end{proposition}
From \cref{prop:modulo-alpha-of-f_1}, we still have
\begin{proposition}
...
\begin{proof}
    ...
    From \cref{prop:modulo-alpha-of-f_1}, $\forall k\in\mathbb{Z}$ that $f_{1}(\bm{a} + k\Phi_1\bm{e}_1) > 0$, there is $f_{1}(\bm{a} + k\Phi_1\bm{e}_1) \equiv k\nabla_1 + f_{1}(\bm{a}) \pmod{\alpha}$ runs all remainders modulo $\alpha$. Thus $\mathbb{S}_{1}(b)/\alpha = \mathbb{Z}/\alpha$.\newline
...
\begin{proof}
    ...
    From \cref{prop:modulo-alpha-of-f_1}, $\forall k\in\mathbb{Z}$ such that $f_{1}(\bm{a} + k\Phi_1\bm{e}_1) > 0$, we have
...
\begin{theorem}\label{thm:layers-of-reduce-space-and-source-value-set}
    \begin{align*}
        \mathbb{S}_{n+1}(b) &= \bigcup_{a\in \mathbb{S}_{n}(b) - \mathbb{S}_{\infty}} \left\{\left. A_0 = \frac{\cor a  - \gamma}{\alpha}, A_{k+1} = \beta^{\Phi_1} A_{k} + \nabla_1 \right\vert k\in\mathbb{N}\right\} \\
