...
Given $a \in \mathbb{Q}-\beta\mathbb{Q}$ and $\{v_{i}\}_{i=-\infty}^{\infty} \subset \mathbb{N}$ that extends from the Collatz reduces of $a$ and $\forall i, j \in \mathbb{Z}$, there is $\beta \nmid \mathfrak{A}_{i}^{j}$.
