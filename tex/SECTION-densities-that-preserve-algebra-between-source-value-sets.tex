% !TEX root = main.tex
\section{Densities that Preserve Algebra Between Source Value Sets}~\label{sec:densities-that-preserve-algebra-between-source-value-sets}
...
\begin{proposition}
	$\forall a, a' \in \mathbb{F}_{1}(b) - \mathbb{S}$, there is
	\[ \beta^{\rdu\val(a';1)}\cdot\mu\mathbb{F}(a') = \beta^{\rdu\val(a;1)}\cdot\mu\mathbb{F}(a). \]
\end{proposition}
\begin{proposition}
